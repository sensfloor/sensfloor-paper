...
Other floor-based sensing approaches, particularly foot pressure-based systems, have also been explored for human movement analysis using neural network models, including intelligent carpets \cite{luo2021intelligentcarpetinferring} and pressure-sensing insoles \cite{watanabe2025p2pinsolehumanpose}. However, the feasibility of estimating full-body 3D walking poses specifically from SensFloor signals remains largely unexplored.
