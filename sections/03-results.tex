...
Furthermore the figure explains the big difference for the results of the Percentage Correct Key points (PCK) between a 5~cm and 10~cm threshold on the ankles. As the Interquartile range for the MJPE of the feet ankles lay just above 5~cm the PCK for this threshold is $36\%$ where for 10~cm it is $70\%$.
The mean PCK of all joints for 5~cm is $63\%$ and for 10~cm it is $87\%$.
\todo{should we Maybe the val\_loss graph or sth would be nice}
The full metrics can be found in annex ref\todo{ref annex}.
