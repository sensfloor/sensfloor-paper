...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\columnwidth]{img/mjpe.pdf}
    \caption{Mean Joint Position Error Boxplot for each joint on the testset. The box is the Interquartile Range (IQR) and the Whiskers extend the box by $1.5\times$ IQR. Left and Right are abbreviated to 'L.' and 'R.'}
    \Description{}
    \label{fig:mjpe}
\end{figure}
