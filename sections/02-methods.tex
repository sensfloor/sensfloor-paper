...
To assess the model performance, we utilize two metrics: Mean Per Joint Position Error (MPJPE) and Percentage of Correct Key Points (PCK) \cite[22 f.]{zheng2023deeplearningbasedhuman}. MPJPE quantifies the average Euclidean distance between estimated and target joints, while PCK measures the percentage of estimates whose distance errors fall below a threshold, which we set at 5~cm (PCK@5) and 10~cm (PCK@10).
